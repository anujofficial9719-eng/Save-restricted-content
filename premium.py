...
async def my_plan(client: Client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📞 Contact Admin", url="https://t.me/arafta_hindi_dubbed_webseries")]
    ])
...
async def show_premium_plans(message_or_query):
    ...
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("💳 Buy Premium Now", url="https://t.me/arafta_hindi_dubbed_webseries")],
